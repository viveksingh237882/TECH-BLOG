<%-- 
    ...
    Created on : 23-Feb-2022, 10:44:58 pm
    Author     : Dell
--%>
...
<html>
    <head>
        ...
        <title><%= p.getpTitle()%>||TechBlog with Learn COde with Vivek</title>
        <!--css-->
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav mr-auto">
                    <li class="nav-item active">
                        <a class="nav-link" href="profile.jsp"><span class="fa fa-bell-o"></span>Code with vivek <span class="sr-only">(current)</span></a>
                    </li>
            ...
            <div class="row my-4">
                <div class="col-md-8 offset-md-2">
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <img class="card-img-top my-2" src="blog_pics/<%=p.getpPic()%>" alt="Card img cap">
                            ...
                            <div class="row my-2 row_user">
                                ...
                                <div class="col-md-4">
                                    <p calss="post-date"><%= DateFormat.getDateTimeInstance().format(p.getpDate())%></p>
